    ...
    <div class="row">
        <sec:ifNotGranted roles="ROLE_CUSTOMER">
            ...
            %{--<p class="description">A elementum ligula lacus ac quam ultrices a scelerisque praesent vel suspendisse scelerisque a aenean hac montes.</p>--}%
                ...
                <g:form action="saveHouse"  params="[houseId: houseCO?.id ]" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <g:submitButton name="Post" ></g:submitButton>
            ...
            %{--<p class="description">A elementum ligula lacus ac quam ultrices a scelerisque praesent vel suspendisse scelerisque a aenean hac montes.</p>--}%
                ...
                <g:form action="saveOffice" params="[officeId: officeCO?.id]" method="post">
